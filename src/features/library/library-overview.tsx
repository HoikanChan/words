    ...
    <MobileShell>
      ...
      <section className="paper-card mt-5 rounded-[28px] p-5">
        ...
        <div className="mt-4 space-y-3">
          ...
          )) : <div className="rounded-[22px] bg-[color:var(--surface-low)] p-4 text-sm text-muted">数据库里还没有词库。</div>}
        </div>
      </section>
      <section className="paper-card mt-5 rounded-[28px] p-5">
        ...
        <div className="space-y-3">
          ...
          )) : <div className="rounded-[22px] bg-[color:var(--surface-low)] p-4 text-sm text-muted">数据库里还没有词条。</div>}
        </div>
      </section>
    </MobileShell>
  );
